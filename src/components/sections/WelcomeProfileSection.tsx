  ...
  return (
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500/20 to-orange-500/20 border border-green-500/30 rounded-full px-4 py-2 mb-4">
          <Sparkles className="w-4 h-4 text-green-400" />
          <span className="text-sm font-semibold text-green-300">WealthKarma AI Financial Planner</span>
          <Brain className="w-4 h-4 text-orange-400" />
        </div>
        <h1 className="heading-h1 text-theme-light mb-4">
      ...
      {/* Your AI Journey */}
      <Card className="mb-8 border-green-500/30 hover-lift">
        <CardHeader>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center group">
              <div className="w-12 h-12 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform border border-orange-500/30">
                <Shield className="w-6 h-6 text-orange-400" />
              </div>
              <h3 className="font-semibold mb-2 text-theme-light">Smart Emergency Planning</h3>
            ...
            <div className="text-center group">
              <div className="w-12 h-12 bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform border border-yellow-500/30">
                <Target className="w-6 h-6 text-yellow-400" />
              </div>
              <h3 className="font-semibold mb-2 text-theme-light">Personalized Goals</h3>
              <p className="text-sm text-theme-secondary">
            ...
            <div className="text-center group">
              <div className="w-12 h-12 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform border border-green-500/30">
                <TrendingUp className="w-6 h-6 text-green-400" />
              </div>
              <h3 className="font-semibold mb-2 text-theme-light">Investment Strategy</h3>
              <p className="text-sm text-theme-secondary">
            ...
            <div className="text-center group">
              <div className="w-12 h-12 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform border border-purple-500/30">
                <Zap className="w-6 h-6 text-purple-400" />
              </div>
              <h3 className="font-semibold mb-2 text-theme-light">Action Plan</h3>
              <p className="text-sm text-theme-secondary">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="input-dark w-full px-3 py-2 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="input-dark w-full rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors"
                >
